...
class DeepMimicParahomeLocalHist(DeepMimicParahome): 
...
class DeepMimicParahomeLocalHistRIS(DeepMimicParahomeLocalHist):
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        super().__init__(cfg=cfg,
                         sim_params=sim_params,
                         physics_engine=physics_engine,
...
class DeepMimicParahomeLocalHistRISBuffernode(DeepMimicParahomeLocalHistRIS):
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        super().__init__(cfg=cfg,
                    sim_params=sim_params,
                    physics_engine=physics_engine,
