...
from utils.paramotion_data_handler import ParaMotionDataHandlerOfflineNew
from env.tasks.humanoid_object_task import HumanoidWholeBodyWithObject


class OfflineStateSearchParahome(HumanoidWholeBodyWithObject): 
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        ...
        self._motion_data = ParaMotionDataHandlerOfflineNew(motion_file, 180, self.device, self._key_body_ids, self.cfg, self.num_envs, 
