CUDA_VISIBLE_DEVICES=3 python skillmimic/run.py \
  --seed 3506\
  --experiment Move_cup_from_desk_to_table\
  ...
  --motion_file skillmimic/data/motions/ParaHome/Move_cup_from_desk_to_table/ \
  ...
  --headless \
  --resume_from output/Move_cup_from_desk_to_table_13-03-22-54/nn/Move_cup_from_desk_to_table.pth
  # --wandb_id
    ...
    #https://wandb.ai/SceneMimic/intermimic/runs/sv3er3i0