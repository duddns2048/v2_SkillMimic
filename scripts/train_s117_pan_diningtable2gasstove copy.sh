CUDA_VISIBLE_DEVICES=7 python skillmimic/run.py \
  --experiment Move_pan_from_gas_stove_to_table\
  --task  SkillMimicParahomeLocalHistRISBuffernode\
  --episode_length 60 \
  --cfg_env skillmimic/data/cfg/parahome_sm/parahome_s117_pan_diningtable2gasstove_hist60_noisyinit_simpara.yaml \
  --cfg_train skillmimic/data/cfg/train/rlg/parahome.yaml \
  --motion_file skillmimic/data/motions/ParaHome/Move_pan_from_gas_stove_to_table/ \
