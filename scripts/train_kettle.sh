CUDA_VISIBLE_DEVICES=5 python skillmimic/run.py \
  --seed 7394 \
  --experiment Move_kettle_from_table_to_desk\
  --task  SkillMimicParahomeLocalHistRISBuffernode\
  --episode_length 60 \
  --cfg_env skillmimic/data/cfg/parahome_sm/parahome_s110_kettle_table2desk_hist60_noisyinit_simpara.yaml \
  --cfg_train skillmimic/data/cfg/train/rlg/parahome.yaml \
  --motion_file skillmimic/data/motions/ParaHome/Move_kettle_from_table_to_desk/ \
  ...
  --headless \
  --resume_from output/Move_kettle_from_table_to_desk_13-06-11-20/nn/Move_kettle_from_table_to_desk.pth\
  --wandb_id xbthkxa0
    ...
    # https://wandb.ai/SceneMimic/intermimic/runs/xbthkxa0